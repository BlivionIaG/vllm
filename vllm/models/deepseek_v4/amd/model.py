...
class DeepseekV4Model(nn.Module, EagleModelMixin):
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        for name, loaded_weight in weights:
            ...
            # Checkpoints may carry duplicate shared-expert tensors in both
            # the unfused HF layout (gate_up_proj/down_proj) and the w1/w2/w3
            # layout; when the w-layout was verified present, skip the unfused
            # duplicates so they don't clobber the stacked-param loads.
